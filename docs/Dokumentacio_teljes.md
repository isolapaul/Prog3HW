...
Az alkalmazás osztálydiagramja az alábbi ábrán látható. A forráskód minden osztálya és metódusa Javadoc kommentekkel van ellátva a `src/main/java/hu/prog3/offlinechatprog3/` mappában.
